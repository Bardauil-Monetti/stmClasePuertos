...
void setup() {
  ...
  GPIOA ->CRL= 0111111111;// DECLARAR PINES OTPUT PUSH_PULL
  GPIOB ->CRL= 0X44444444;
  GPIOB ->CRL |=GPIO_CRL_CNF0_0 | ~GPIO_CRL_MODE0;// DECLARAR REGISTROS MASCARAS
